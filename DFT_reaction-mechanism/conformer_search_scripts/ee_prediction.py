...
print("ddG =", np.round(deltaG,1), "kJ/mol")
print("ddG =", np.round((first_value_minor - first_value)*627.5,1), "kcal/mol")
...
print("ddG =", np.round(deltaG_boltzmann,1), "kJ/mol")
print("ddG =", np.round(deltaG_boltzmann*0.239,1), "kcal/mol")
