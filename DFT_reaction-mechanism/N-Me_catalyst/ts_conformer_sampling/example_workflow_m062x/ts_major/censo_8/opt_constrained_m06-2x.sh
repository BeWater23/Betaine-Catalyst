...
##   - for more options, see 'man msub'
##   - '# SBATCH' is a comment, while '#SBATCH' is a sbatch statement

#########################################
## E D I T  here your SBATCH resources ##
#########################################
#SBATCH --job-name opt_constrained_m06-2x
#SBATCH --ntasks-per-node=48 --nodes=1
#SBATCH --mem-per-cpu=2200
#SBATCH --time=72:00:00
#SBATCH --output=opt_constrained_m06-2x.out
#SBATCH --error=opt_constrained_m06-2x.err
...
module load chem/turbomole/7.7.1 ## this loads Turbomole version 7.7.1
...
## QS_SUBMITDIR is the dir in which you did type 'msub ...'.
...
chemsh opt_constrained_m06-2x.chm > ${QS_SUBMITDIR}/chemsh_${QS_JOBID}.out 2>chemsh.err
