...
#########################################
#SBATCH --job-name spe_ts_m06-2x
#SBATCH --ntasks-per-node=48 --nodes=1
#SBATCH --mem-per-cpu=2200
#SBATCH --time=08:00:00
#SBATCH --output=spe_ts_m06-2x.out
#SBATCH --error=spe_ts_m06-2x.err
...
chemsh spe_ts_m06-2x.chm > ${QS_SUBMITDIR}/chemsh_${QS_JOBID}.out 2>chemsh.err
