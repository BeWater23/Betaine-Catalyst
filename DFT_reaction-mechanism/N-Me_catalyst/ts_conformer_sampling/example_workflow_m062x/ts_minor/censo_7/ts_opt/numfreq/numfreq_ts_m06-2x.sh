...
#########################################
#SBATCH --job-name numfreq_ts_m06-2x
#SBATCH --ntasks-per-node=48 --nodes=1
#SBATCH --mem-per-cpu=2200
#SBATCH --time=72:00:00
#SBATCH --output=numfreq_ts_m06-2x.out
#SBATCH --error=numfreq_ts_m06-2x.err
...
chemsh numfreq_ts_m06-2x.chm > ${QS_SUBMITDIR}/chemsh_${QS_JOBID}.out 2>chemsh.err
