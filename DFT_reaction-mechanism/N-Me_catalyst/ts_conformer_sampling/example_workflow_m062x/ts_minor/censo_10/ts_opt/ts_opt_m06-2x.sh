...
#########################################
#SBATCH --job-name ts_opt_m06-2x
#SBATCH --ntasks-per-node=48 --nodes=1
#SBATCH --mem-per-cpu=2200
#SBATCH --time=72:00:00
#SBATCH --output=ts_opt_m06-2x.out
#SBATCH --error=ts_opt_m06-2x.err
...
chemsh ts_opt_m06-2x.chm > ${QS_SUBMITDIR}/chemsh_${QS_JOBID}.out 2>chemsh.err
